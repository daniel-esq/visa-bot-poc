    ...
    return (
        <div className="app-page">
            ...
            <main className="govuk-width-container govuk-main-wrapper" id="main-content" role="main">
                <div className="app-hero govuk-!-margin-bottom-6">
                    <span className="govuk-caption-xl">Visa services</span>
                    <h1 className="govuk-heading-xl govuk-!-margin-bottom-2">Apply for a Standard Visitor visa</h1>
                    <p className="govuk-body">
                        Use this prototype to work through the key questions we need to capture for your application before
                        submitting it.
                    </p>
                </div>
                ...
                <div className="govuk-grid-row">
                    <div className="govuk-grid-column-two-thirds">
                        <section className="govuk-!-margin-bottom-7">
                            <h2 className="govuk-heading-l">Provide your details</h2>
                            <p className="govuk-body">
                                Answer one question at a time. We will validate each answer and show the structured
                                information that will be sent to Home Office systems.
                            </p>
                            ...
                            <div className="govuk-button-group">
                                ...
                                {currentStep === questions.length - 1 && (
                                    ...
                                    >
                                        {wizardLoading ? "Submittingâ€¦" : "Submit responses"}
                                    </button>
                                )}
                            </div>

                            <p className="govuk-body govuk-!-margin-top-3">
                                <strong>Progress:</strong> Step {currentStep + 1} of {questions.length}
                            </p>

                            <h3 className="govuk-heading-m govuk-!-margin-top-6">Review your answers</h3>
                            ...
                            <div className="govuk-inset-text" style={{ maxHeight: 240, overflow: "auto" }}>
                                <code>
                                    {wizardFinalJson
                                        ? JSON.stringify(wizardFinalJson, null, 2)
                                        : "The structured payload will appear after submission."}
                                </code>
                            </div>
                        </section>

                        <section className="govuk-!-margin-bottom-7">
                            <h2 className="govuk-heading-l">Live assistant (beta)</h2>
                            <p className="govuk-body">
                                Use the streaming endpoint to capture free-form information and watch the OpenAI Responses API
                                return structured data in real time.
                            </p>
                            ...
                            <div className="govuk-form-group">
                                ...
                                <div id="message-hint" className="govuk-hint">
                                    For example: <code>{exampleMessage}</code>
                                </div>
                                <textarea
                                    id="message"
                            ...
                            <div className="govuk-button-group">
                                <button
                                    type="button"
                                    className={classNames("govuk-button", isStreaming && "govuk-button--secondary")}
                                ...
                                <button
                                    type="button"
                                    className="govuk-button govuk-button--secondary"
                                    onClick={() => setUserMessage(exampleMessage)}
                                >
                                    Use example text
                                </button>
                            </div>
                            ...
                            <div className="govuk-grid-row govuk-!-margin-top-6">
                                <div className="govuk-grid-column-one-half">
                                    <h3 className="govuk-heading-m">Live transcript</h3>
                                    <div
                                        ref={scrollRef}
                                        className="govuk-inset-text"
                                        style={{ maxHeight: 260, overflow: "auto", whiteSpace: "pre-wrap" }}
                                    >
                                        {transcript || (isStreaming ? "Waiting for tokensâ€¦" : "(No output yet)")}
                                    </div>
                                </div>
                                <div className="govuk-grid-column-one-half">
                                    <h3 className="govuk-heading-m">Final structured data</h3>
                                    <div className="govuk-inset-text" style={{ maxHeight: 260, overflow: "auto" }}>
                                        <code>
                                            {finalJson
                                                ? JSON.stringify(finalJson, null, 2)
                                                : "The structured JSON will appear here."}
                                        </code>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="govuk-!-margin-top-6">
                                <h3 className="govuk-heading-m">Debug events</h3>
                                <table className="govuk-table">
                                    <thead className="govuk-table__head">
                                    <tr className="govuk-table__row">
                                        <th scope="col" className="govuk-table__header">#</th>
                                        <th scope="col" className="govuk-table__header">Event</th>
                                        <th scope="col" className="govuk-table__header">Payload / data</th>
                                    </tr>
                                    </thead>
                                    <tbody className="govuk-table__body">
                                    {events.length === 0 && (
                                        <tr className="govuk-table__row">
                                            <td className="govuk-table__cell" colSpan={3}>(No events yet)</td>
                                        </tr>
                                    )}
                                    {events.map((e, i) => (
                                        <tr className="govuk-table__row" key={i}>
                                            ...
                                            <td className="govuk-table__cell">
                                                <code style={{ whiteSpace: "pre-wrap" }}>
                                                    {JSON.stringify(e.event === "message" ? e.payload : e.data, null, 2)}
                                                </code>
                                            </td>
                                        </tr>
                                    ))}
                    ...
                    <aside className="govuk-grid-column-one-third">
                        <div className="app-side-panel">
                            ...
                            <ul className="govuk-list govuk-list--bullet">
                                ...
                                <li>Travel history and reason for visit</li>
                                <li>Proof of funds to cover your stay</li>
                            </ul>
                            <p className="govuk-body">
                                You can save and return to this prototype at any time during user research.
                            </p>

                            <h3 className="govuk-heading-m govuk-!-margin-top-4">Need help?</h3>
                            <p className="govuk-body">
                                Contact the visa support team on <a href="tel:03001234567">0300 123 4567</a> or email
                                <a href="mailto:visa-support@example.gov.uk"> visa-support@example.gov.uk</a>.
                            </p>

                            <h3 className="govuk-heading-m govuk-!-margin-top-4">Related guidance</h3>
                            <ul className="govuk-list">
                                <li><a href="#">What you can and cannot do on a Standard Visitor visa</a></li>
                                <li><a href="#">Supporting documents checklist</a></li>
                            </ul>
                        </div>
                    </aside>
                </div>
